  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Image
        ...
        style={styles.image}
      />
      <Text style={[styles.headingStyle, styles.fontUrdu]}>
        کورس کے بارے میں
      </Text>
      <Text style={[styles.description, styles.fontUrdu]}>
        سی پلس پلس ایک عام مقصد کے لیے استعمال ہونے والی پروگرامنگ زبان ہے جو
        ویب ڈویلپمنٹ، ڈیٹا تجزیہ، اور گیم ڈویلپمنٹ سمیت کئی مختلف کاموں کے لیے
        استعمال ہوتی ہے۔
      </Text>
